...
$query = query("SELECT * FROM management WHERE id_management = $id")[0];
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body d-flex justify-content-center align-items-center">
                            <div class="card" style="width: 34rem;">
                                <div class="card-header">
                                    <h4 class="mb-0">Edit User Management</h4>
                                </div>
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?= $query['id_management']; ?>">
                                        <div class="row mb-3">
                                            <label for="kodeStock" class="col-sm-2 col-form-label" style="width: 7rem;">NIK</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="kodeStock" name="nik" value="<?= $query['nik']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
