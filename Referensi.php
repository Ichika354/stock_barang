                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body d-flex justify-content-center align-items-center">
                            <div class="card" style="width: 34rem;">
                                <div class="card-header">
                                    <h4 class="mb-0">Add Referensi Stock</h4>
                                </div>
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="row mb-3">
                                            <label for="kodeStock" class="col-sm-2 col-form-label" style="width: 7rem;">Kode Stock</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="kodeStock" name="kodeStock" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="namaStock" class="col-sm-2 col-form-label"  style="width: 7rem;">Nama Stock</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="namaStock" name="namaStock" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            <label for="deskripsi" class="col-sm-2 col-form-label"  style="width: 7rem;">Deskripsi</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" class="form-control" id="gambar" name="foto" accept="image/*" required>
                                            </div>
                                        </div>
